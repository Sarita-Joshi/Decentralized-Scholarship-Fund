...
const DonationTable = () => {
    ...
    const donations = [
        { id: 1, address: '0xABC123...', amount: 5, date: '2024-11-15', fund: 'Gym Fund' },
        { id: 2, address: '0xDEF456...', amount: 10, date: '2024-11-14', fund: 'Animal Welfare' },
        { id: 3, address: '0xGHI789...', amount: 2, date: '2024-11-13', fund: 'Community Support' },
    ];

    // Generate dynamic color for fund tag based on fund name
    const getDynamicColor = (fund) => {
        const colors = [
            '#d4edda', '#fff3cd', '#f8d7da', '#d1ecf1', '#f2d7ee', '#e8e8e8'
        ...
        <div className="donation-table">
            <div className="controls">
                ...
                <select value={filterFund} onChange={(e) => setFilterFund(e.target.value)}>
                    <option value="">Filter by Fund</option>
